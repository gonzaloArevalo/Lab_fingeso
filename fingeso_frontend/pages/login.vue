      ...
      switch (this.tipoUsuario) {
        case 1:
          await this.autenticar(
            "/admin/login/" + this.correo + "/" + this.contrasena
          );
          break;
        case 2:
          await this.autenticar(
            "/residente/login/" + this.correo + "/" + this.contrasena
          );
          break;
        case 3:
          await this.autenticar(
            "/subadmin/login/" + this.correo + "/" + this.contrasena
          );
          break;
        case 4:
          await this.autenticar(
            "/personal/login/" + this.correo + "/" + this.contrasena
          );
          break;
        default:
          break;
